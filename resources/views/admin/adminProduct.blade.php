                        ...
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button data-toggle="tooltip" title="Edit" class="pd-setting-ed"> <a href="{{url('edit-product/' . $row->productID)}}" class="btn btn-primary">Edit</a></button>
                                        <button data-toggle="tooltip" title="Delete" class="pd-setting-ed"><a href="{{url('delete-product/' . $row->productID)}}" class="btn btn-danger"
