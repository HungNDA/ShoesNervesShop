...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <!-- Logo -->
            <div class="logo">
                <a href="{{url('home')}}"><img src="{{ url('public') }}/fe/img/core-img/LoGo (3).png" alt=""></a>
            </div>
            <!-- Amado Nav -->
            <nav class="amado-nav">
                <ul>
        ...
        <div class="products-catagories-area clearfix">
            <div class="amado-pro-catagory clearfix">
                ...
                <div class="single-products-catagory clearfix">
                    <a href="#">
                        <img src="{{url('public')}}/fe/img/bg-img/admin2.jpg" alt="">
                        <!-- Hover Content -->
                ...
                <div class="single-products-catagory clearfix">
                    <a href="#">
                        <img src="{{url('public')}}/fe/img/bg-img/admin1.jpg" alt="" style="max-height: 700px; width: 450px; padding-left:50px">
                        <!-- Hover Content -->
                        <div class="hover-content">
                            <div class="line"></div>
                            <p>Aero Spaces Manager</p>
                            <h4>Anh Quan </h4>
                        </div>
                    </a>
                </div>
                <div class="single-products-catagory clearfix">
                    <a href="#">
                        <img src="{{url('public')}}/fe/img/bg-img/admin3.jpg" alt="" style="height: 700px; width: 500px">
                        <!-- Hover Content -->
                        <div class="hover-content">
                            <div class="line"></div>
                            <p style="color: #eee">Zod pet</p>
                            <h4>Duy 's dog </h4>
                        </div>
                    </a>
                </div>
