    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="shop_sidebar_area">
            ...
            <div class="widget catagory mb-50">
                <!-- Widget Title -->
                <h6 class="widget-title mb-30">Product</h6>
                ...
                <div class="widget-desc">
                    {{-- @foreach ($data2 as $row)
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="Nike">{{$row->prodcerName}}</label>
                        </div>
                    @endforeach --}}
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="MLB">MLB</label>
                    </div>
                    <!-- Single Form Check -->
                    <div class="form-check">
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="single-product-wrapper">
                                ...
                                <div class="product-img">
                                    <img src="{{ url('public') }}/fe/img/Product-img/{{ $row->productImage1 }}"
                                        alt="">
                                    <!-- Hover Thumb -->
                                ...
                                <div class="product-description d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="product-meta-data">
                                        ...
                                        <a href={{url('detail/'. $row->productID)}}>
                                            <h6>{{ $row->productDetail }}</h6>
                                        </a>
                                    </div>
                                    <!-- Ratings & Cart -->
                                        ...
                                        <div class="cart">
                                            <a href="cart.html" data-toggle="tooltip" data-placement="left"
                                                title="Add to Cart"><img
                                                    src="{{ url('public') }}/fe/img/core-img/cart.png"
                                                    alt=""></a>
                                        </div>
                                    </div>
                                </div>
