    ...
    if (!i && c)
        if ("function" == typeof __webpack_require__)
            ...
            if (void 0 !== require.resolve)
                ...
                void 0 !== require.specified &&
                    (i = require.specified("codemirror"));
    var j =
            ...
            var b = function (b) {
                ...
                h = function (a) {
                    return (
                        !b(a) &&
                        a &&
                        /^DIV|^P|^LI|^H[1-7]/.test(a.nodeName.toUpperCase())
                    );
                },
                i = function (a) {
                ...
                ba = function (a, c) {
                    ...
                    if (0 === a.offset) {
                        ...
                        aa(a.node)
                            ? ((d = a.node.childNodes[a.offset - 1]),
                              (e = G(d)))
                ...
                za = function (a) {
                    return (
                        a &&
                        !o.isText(a) &&
                        m.contains(a.classList, "note-styletag")
                    );
                };
            return {
                NBSP_CHAR: n,
        ...
        p = function (b, c) {
            ...
            return (
                ...
                (this.removeModule = function (a) {
                    var c = this.modules[a];
                    c.shouldInitialize() &&
                        (c.events && o.detachEvents(b, c.events),
                        c.destroy && c.destroy()),
                ...
                (this.createInvokeHandler = function (b, c) {
                    return function (e) {
                        ...
                        d.invoke(
                            b,
                            c || f.closest("[data-value]").data("value"),
                            f
                        );
                    };
                }),
    ...
    a.fn.extend({
        summernote: function () {
            ...
            (e = a.extend({}, a.summernote.options, e)),
                ...
                (e.tooltip =
                    "auto" === e.tooltip ? !k.isSupportTouch : e.tooltip),
                this.each(function (b, c) {
                    ...
                    if (!d.data("summernote")) {
                        ...
                        d.data("summernote", f),
                            d
                                .data("summernote")
                                .triggerEvent("init", f.layoutInfo);
                    }
                });
            var f = this.first();
            if (f.length) {
                    ...
                    var d = a.isArray(arguments[0]) ? arguments[0] : [],
                        e =
                            "object" == typeof arguments[1]
                                ...
                                : arguments[0];
                    return (
                        e && e.children && (d = e.children), new q(b, d, e, c)
                    );
                };
            },
        },
    ...
    var K = (function () {
        ...
        L = (function () {
                ...
                c = function (a) {
                    var b = function (a, c) {
                            ...
                            if (o.isText(a)) {
                                ...
                                if (((d = a.childNodes[c] || a), o.isText(d)))
                                    return b(d, 0);
                                (c = 0), (e = !1);
                            }
                ...
                d = function (b, e, f, g) {
                    ...
                    (this.isOnEditable = i(o.isEditable)),
                        ...
                        (this.isLeftEdgeOf = function (a) {
                            if (!o.isLeftEdgePoint(this.getStartPoint()))
                                return !1;
                        ...
                        (this.insertNode = function (a) {
                            ...
                            return (
                                c.rightNode
                                    ? c.rightNode.parentNode.insertBefore(
                                          a,
                                          c.rightNode
                                      )
                        ...
                        (this.paraBookmark = function (a) {
                            return {
                                s: {
                                    path: m.tail(
                                        o.makeOffsetPath(m.head(a), b)
                                    ),
                                    offset: e,
                                },
                                e: {
                                    path: m.tail(
                                        o.makeOffsetPath(m.last(a), f)
                                    ),
                                    offset: g,
                                },
                            };
            ...
            return {
                ...
                createFromNode: function (a) {
                    ...
                    return (
                        o.isVoid(b) &&
                            ((c = o.listPrev(b).length - 1),
                            (b = b.parentNode)),
                        o.isBR(d)
                            ? ((e = o.listPrev(d).length - 1),
                              (d = d.parentNode))
                            : o.isVoid(d) &&
                              ((e = o.listPrev(d).length), (d = d.parentNode)),
                        this.create(b, c, d, e)
                    );
                },
            ...
            var b = [],
                ...
                f = function (b) {
                    null !== b.contents && a.html(b.contents),
                        null !== b.bookmark &&
                            L.createFromBookmark(d, b.bookmark).select();
                };
        ...
        O = function () {
            ...
            (this.fromNode = function (a) {
                ...
                (this.stylePara = function (b, c) {
                    a.each(
                        b.nodes(o.isPara, { includeAncestor: !0 }),
                        function (b, d) {
                            a(d).css(c);
                        }
                    );
                ...
                (this.styleNodes = function (b, c) {
                    ...
                    var g = o.makePredByNodeName(d),
                        h = b
                            .nodes(o.isText, { fullyContains: !0 })
                            .map(function (a) {
                                return (
                                    o.singleChildAncestor(a, g) || o.wrap(a, d)
                                );
                            });
                    if (e) {
                        if (f) {
                        ...
                        return h.map(function (b) {
                            ...
                            return (
                                a.each(e, function (a, b) {
                                    o.appendChildNodes(d, b.childNodes),
                                        o.remove(b);
                                }),
                                m.head(c)
                            );
                ...
                (this.current = function (b) {
                    ...
                    if (g && g.style["line-height"])
                        ...
                        var h =
                            parseInt(d["line-height"], 10) /
                            parseInt(d["font-size"], 10);
                        d["line-height"] = h.toFixed(1);
                    }
                    return (
                        (d.anchor =
                            b.isOnAnchor() && o.ancestor(b.sc, o.isAnchor)),
            ...
            (this.insertOrderedList = function (a) {
                ...
                (this.wrapList = function (a, b) {
                    ...
                    return (
                        ...
                        f &&
                            (o.appendChildNodes(g, m.from(f.childNodes)),
                            o.remove(f)),
                        a
                    );
                }),
                ...
                (this.insertParagraph = function (c) {
                    ...
                    if (f) {
                        ...
                        if (
                            ...
                            (g = g.concat(
                                o.listDescendant(e, o.isEmptyAnchor)
                            )),
        ...
        R = function (a, b, c, d) {
            function e() {
                return !a ||
                    !a.tagName ||
                    ("td" !== a.tagName.toLowerCase() &&
                        "th" !== a.tagName.toLowerCase())
                    ? void console.error(
            ...
            function l(a) {
                switch (b) {
                    case R.where.Column:
                        if (a.isColSpan)
                            return R.resultAction.SubtractSpanCount;
                        break;
                    case R.where.Row:
        ...
        T = function () {
            (this.tab = function (a, b) {
                ...
                (this.addRow = function (b, c) {
                    ...
                    if ("top" === c) e.before(g);
                        ...
                        if (d.rowSpan > 1) {
                            ...
                            return void a(a(e).parent().find("tr")[p]).after(
                                a(g)
                            );
                        }
                        e.after(g);
                ...
                (this.createTable = function (b, c, d) {
                    ...
                    e = f.join("");
                    for (var h, i = [], j = 0; j < c; j++)
                        i.push("<tr>" + e + "</tr>");
                    h = i.join("");
                    var k = a("<table>" + h + "</table>");
                    return (
                        d && d.tableClassName && k.addClass(d.tableClassName),
                        k[0]
                    );
                }),
        ...
        U = function (b) {
            ...
            (this.tab = function () {
                        ...
                        .then(function (a) {
                            t(),
                                "function" == typeof c
                                    ? c(a)
                                    : ("string" == typeof c &&
                                          a.attr("data-filename", c),
                                      a.css(
                                          "width",
                                          Math.min(f.width(), a.width())
                                      )),
                                a.show(),
                ...
                (this.insertImages = function (d) {
                    a.each(d, function (a, d) {
                        var e = d.name;
                        g.maximumImageFileSize &&
                        g.maximumImageFileSize < d.size
                            ? b.triggerEvent(
                                  "image.upload.error",
                ...
                (this.insertNode = this.wrapCommand(function (a) {
                    this.createRange().insertNode(a),
                        L.createFromNodeAfter(a).select();
                })),
                ...
                (this.formatBlock = this.wrapCommand(function (a, c) {
                    ...
                    d
                        ? d.call(this, c, b, this.onFormatBlock)
                        : this.onFormatBlock(a);
                })),
            ...
            (this.fontSize = function (b) {
                ...
                if (c && c.isCollapsed()) {
                    ...
                    t(), a(n.styleNodes(c)).css({ "font-size": b + "px" }), u();
            }),
                (this.insertHorizontalRule = this.wrapCommand(function () {
                    var a = this.createRange().insertNode(o.create("HR"));
                    a.nextSibling &&
                        L.create(a.nextSibling, 0).normalize().select();
                })),
                b.memo(
                    "help.insertHorizontalRule",
                    h.help.insertHorizontalRule
                ),
                ...
                (this.getLinkInfo = function () {
                    ...
                    return (
                        c.length &&
                            (d.isNewWindow = "_blank" === c.attr("target")),
                        d
                    );
                }),
                ...
                (this.pasteByEvent = function (a) {
                    ...
                    if (c && c.items && c.items.length) {
                        ...
                        "file" === d.kind &&
                            ...
                            b.invoke("editor.insertImagesOrCallback", [
                                d.getAsFile(),
                            ]),
                ...
                (this.attachDragAndDropEvent = function () {
                    ...
                    (h.onDragenter = function (a) {
                        ...
                        (h.onDragleave = function (a) {
                            (f = f.not(a.target)),
                                f.length || d.removeClass("dragover");
                        }),
                        (h.onDrop = function () {
    ...
    var X = function (a) {
        ...
        Y = function (b) {
            var c = a(document),
                ...
                f = b.options;
            (this.initialize = function () {
                if (f.airMode || f.disableResizeEditor)
                ...
                d.on("mousedown", function (a) {
                    ...
                    var b = e.offset().top - c.scrollTop(),
                        d = function (a) {
                            ...
                            (c =
                                f.minheight > 0 ? Math.max(c, f.minheight) : c),
                                (c =
                                    f.maxHeight > 0
                                        ? Math.min(c, f.maxHeight)
                                        : c),
                                e.height(c);
                        };
                ...
                (this.update = function (c) {
                    ...
                    if ((b.invoke("imagePopover.update", c), d)) {
                        var f = a(c),
                            ...
                            h = {
                                left:
                                    g.left + parseInt(f.css("marginLeft"), 10),
        ...
        _ = function (b) {
            ...
            (this.events = {
                ...
                (this.handleKeyup = function (a) {
                    m.contains([K.code.ENTER, K.code.SPACE], a.keyCode) &&
                        this.replace();
                });
        },
        aa = function (a) {
        ...
        ba = function (b) {
            ...
            (this.events = {
                ...
                (this.update = function () {
                    var a =
                        !b.invoke("codeview.isActivated") &&
                        b.invoke("editor.isEmpty");
                    ...
                    return (
                        c.fontInstalledMap.hasOwnProperty(a) ||
                            (c.fontInstalledMap[a] =
                                k.isFontInstalled(a) ||
                                m.contains(f.fontNamesIgnoreCheck, a)),
                        c.fontInstalledMap[a]
                    );
                }),
                                ...
                                d.dropdown({
                                    ...
                                    template: function (a) {
                                        "string" == typeof a &&
                                            (a = {
                                                tag: a,
                                                title: g.style.hasOwnProperty(a)
                                                    ? g.style[a]
                                                    : a,
                                            });
                                        var b = a.tag,
                        ...
                        b.memo("button.hr", function () {
                            return d
                                .button({
                                    ...
                                    tooltip:
                                        g.hr.insert + i("insertHorizontalRule"),
                                    click: b.createInvokeHandler(
                    ...
                    if (
                        (this.updateBtnStates(f, {
                            ...
                            ".note-btn-strikethrough": function () {
                                return (
                                    "strikethrough" === g["font-strikethrough"]
                                );
                            },
                        }),
                        g["font-family"])
        ...
        ea = function (b) {
            ...
            (this.initialize = function () {
                ...
                b.memo(
                    ...
                    f.langInfo.help["linkDialog.show"]
                );
        },
        fa = function (b) {
            var c = this,
        ...
        ga = function (b) {
            ...
            (this.initialize = function () {
                ...
                if (f.maximumImageFileSize) {
                    var h = Math.floor(
                            Math.log(f.maximumImageFileSize) / Math.log(1024)
                        ),
                        i =
                            1 *
                                (
                                    f.maximumImageFileSize / Math.pow(1024, h)
                                ).toFixed(2) +
                            " " +
                            " KMGTP"[h] +
                            "B";
                ...
                (this.createVideoNode = function (b) {
                    ...
                    if (e && 11 === e[1].length) {
                        ...
                        c = a("<iframe>")
                            ...
                            .attr(
                                "src",
                                "https://instagram.com/p/" + g[1] + "/embed/"
                            )
                            .attr("width", "612")
                            .attr("height", "710")
                            .attr("scrolling", "no")
                        ...
                        c = a("<iframe>")
                            ...
                            .attr(
                                "src",
                                "//www.dailymotion.com/embed/video/" + m[2]
                            )
                            .attr("width", "640")
                            .attr("height", "360");
            ...
            (this.createShortCutList = function () {
                    ...
                    .map(function (d) {
                        ...
                        return (
                            f
                                .append(
                                    a(
                                        "<label><kbd>" + d + "</kdb></label>"
                                    ).css({ width: 180, "margin-right": 10 })
                                )
                                .append(
                                    a("<span/>").html(b.memo("help." + e) || e)
                                ),
                            f.html()
                        );
                    })
                ...
                (this.initialize = function () {
                    var b = f.dialogsInBody ? a(document.body) : e,
                        c = [
                            '<p class="text-center">',
                            '<a href="http://summernote.org/" target="_blank">Summernote 0.8.8</a> Ã‚Â· ',
            ...
            (this.events = {
                ...
                (this.moveUp = function () {
                    ...
                    if (b.length) this.selectItem(b);
                        ...
                        var c = a.parent().prev();
                        c.length ||
                            (c = this.$content.find(".note-hint-group").last()),
                ...
                (this.createGroup = function (b, d) {
                    ...
                    return (
                        this.searchKeyword(b, d, function (a) {
                            (a = a || []),
                                a.length &&
                                    (e.html(c.createItemTemplates(b, a)),
                                    c.show());
                        }),
                        e
                    );
                ...
                (this.handleKeyup = function (a) {
                    if (
                        m.contains(
                            [K.code.ENTER, K.code.UP, K.code.DOWN],
                            a.keyCode
                        )
                    ) {
                        if (
